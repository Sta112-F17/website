...
- Assigned on Thursday after class, due Tuesday 10:05am

- Individual assessment
    - Can consult prof and TA
    - Can use internet resources, but can't ask direct questions on the internet
    - Cannot, under any circumstances, consult with each other, not even hyopothetical questions
...
bike %>%
  mutate(alcohol = case_when(
    ...
    Bike_Alc_D == "Missing" & Drvr_Alc_D == "Missing" ~ "Missing"
  ))
```
...
```{r}
bike %>% 
  transmute(date = paste(FID, OBJECTID, sep = "-"))
```
