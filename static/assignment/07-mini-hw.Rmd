...
![diamond_measurements](img/07-mini-hw/diamond_measurements.png)
...
![diamond_colors](img/07-mini-hw/diamond_colors.png)
Lastly, the figure below shows clarity grading of diamonds:

![diamond_clarity](img/07-mini-hw/diamond_clarity.png)
