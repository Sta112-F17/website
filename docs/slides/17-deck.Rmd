...
complication rate of $\hat{p}$ = `r p_hat` be due to chance?
...
Remember **p-value** is probability of observed or more extreme outcome 
...
.pull-left[
![empirical](img/17/yawn1.png)
]
.pull-right[
![empirical](img/17/yawn2.png)
]
